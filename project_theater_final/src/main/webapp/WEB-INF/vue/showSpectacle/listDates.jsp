...
<h2>Date where it has a spectacle</h2>
<ol class="rounded-list">
        <%
            List<spectacle> dates = (List<spectacle>) request.getAttribute("dates");
            for (int i = 0; i < dates.size(); i++) {
                out.println("<li> <a href=\"http://localhost:8080/project_theater_final_war_exploded/listSpectacleByDate?date=" + dates.get(i) + "\">" + dates.get(i) + "</a> </li>");
            }
        %>
</ol>
